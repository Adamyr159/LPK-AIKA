  ...
  <body class="app sidebar-mini">
                  ...
                  <form id="form-foto<?= $no ?>">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="card" id="settings-card">
                        ...
                        <div class="card-body" <p><?= $pengumuman['pengumuman'] ?></p>
    ...
    <script>
      ...
      if ('serviceWorker' in navigator) {
        ...
        navigator.serviceWorker.register('https://rdm.ma.nwkaltara.web.id/rdm-sw.js?ver=1.0.3&revision=20210806202524', {
            scope: 'https://rdm.ma.nwkaltara.web.id/'
          })
